...
ARABIC_NEWS_SOURCES: List[NewsSourceConfig] = [
    ...
    NewsSourceConfig(
        name="Enab Baladi",
        name_ar="عنب بلدي",
        rss_urls=["https://www.enabbaladi.net/feed/"], 
        base_url="https://www.enabbaladi.net/",
        reliability_score=0.70,
        political_lean="center-left",
        region="Syria",
    ),
    NewsSourceConfig(
        name="Zaman Al-Wsl",
        name_ar="زمان الوصل",
        rss_urls=["https://www.zamanalwsl.net/news/rss/15"], 
        base_url="https://www.zamanalwsl.net/",
        reliability_score=0.70,
        political_lean="center",
        region="Syria",
    ),
    NewsSourceConfig(
        name="Noon Post",
        name_ar="نون بوست",
        rss_urls=["https://www.noonpost.com/feed/"], 
        base_url="https://www.noonpost.com/",
        reliability_score=0.60,
        political_lean="center-left",
        region="Turkey",
    ),
    NewsSourceConfig(
        name="Al Araby TV",
        name_ar="التلفزيون العربي",
        rss_urls=["https://www.alaraby.com/rss/news"], 
        base_url="https://www.alaraby.com/",
    ...
    NewsSourceConfig(
        name="The New Arab",
        name_ar="العربي الجديد",
        rss_urls=["https://www.alaraby.co.uk/rss"], 
        base_url="https://www.alaraby.com/",
        reliability_score=0.65,
        political_lean="center-left",
        region="Qatar",
